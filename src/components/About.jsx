          ...
          <div className="flex flex-col gap-6 text-left">
            ...
            <Reveal>
             <p className="text-gray-800 font-medium text-lg leading-relaxed">
                I am a Front-End Developer based in Delhi, focused on building clean and user-friendly web applications. 
                I love turning creative ideas into functional code using modern tools. 
                Currently, I’m refining my skills in React and exploring backend development to become a more versatile developer.
             </p>
            </Reveal>
            ...
            <Reveal>
              <div className="space-y-2 text-lg font-medium text-gray-900 ">
                <p>
                  <span className="text-blue-600 font-bold">Email :</span> rk440138@gmail.com
                </p>
                <p>
                  <span className="text-blue-600 font-bold">Place :</span> Delhi, India
                </p>
              </div>
            </Reveal>
